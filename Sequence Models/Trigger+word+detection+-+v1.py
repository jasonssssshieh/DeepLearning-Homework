...
def is_overlapping(segment_time, previous_segments):
    ...
    for previous_start, previous_end in previous_segments:
        if previous_start >= segment_time[0] and previous_start <= segment_time[1] or previous_end >= segment_time[0] and previous_end <= segment_time[1] or previous_start <= segment_time[0] and previous_end >= segment_time[1]:
            overlap = True
    ### END CODE HERE ###
